            ...
            <div class="modal-body">
                <form action="<?=base?>admin/profile-type/store" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Nhập tên loại hồ sơ">
                    </div>
        ...
        $.ajax({
            ...
            if (data.status) {
                ...
                <form action="<?=base?>admin/profile-type/update" method="POST">
                    <div class="form-group">
                        <label for="exampleFormControlFile1">Nhập Tên Loại Hồ Sơ</label>
                        <input type="text" name="name" value="${data.data.name}" class="form-control" placeholder="Nhập tên loại hồ sơ">
